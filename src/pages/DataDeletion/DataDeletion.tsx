export const DataDeletion = () => {
  return (
    <div className="container mx-auto p-6">
      <strong>Bếu Béo Accessory</strong> là một ứng dụng thao tác đối với website (đăng ký và đăng nhập với Facebook) và
      ...
      <p>
        3. Tìm đến mục “react-authentication-example.vercel.app” trong danh sách và nhấp vào nút “Gỡ” 4. Trong hộp thoại
        xác nhận, bạn xác nhận bằng cách nhấp vào nút "Gỡ". 5. Xin chúc mừng, bạn đã xóa thành công các hoạt động ứng
        dụng của mình.
      </p>
    </div>
  )
